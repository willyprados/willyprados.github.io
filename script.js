...
worksCategories.addEventListener("click", function (e) {
  ...
  for (let i = 0; i < worksContainers.length; i++) {
    console.log(worksCategories.children[i]);
    console.log(worksContainers[i]);

    worksCategories.children[i].innerHTML.toLowerCase() ==
    ...
    //   worksContainers[i].classList.remove("hidden");
    // else if (
    //   !worksContainers[i].classList.contains(e.target.innerHTML.toLowerCase())
    // )
    //   worksContainers[i].classList.add("hidden");
    // else worksContainers[i].classList.remove("hidden");
